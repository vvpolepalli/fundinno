...
<div class="">
  ...
  <tr><td colspan="2">&nbsp;<h3>Note:<span> Amount payable = Pre-Order Amount – FundInnovations Cash.</span> </h3></td></tr>
                                ...
                                <input name="Merchant_Id" id="Merchant_Id" type="hidden" value="{$account_id}">     
                                <input name="Redirect_Url" type="hidden" size="60" value="{$return_url}" />
                                <input name="mode" type="hidden" size="60" value="{$mode}" />
                                <input type="hidden" value="{$secure_hash}" size="60" name="secure_hash">
                                <input name="reference_no" type="hidden" value="{$WorkingKey}" />
                                <input name="Amount" type="hidden" value="{$amount}"/>
                                <input name="description" type="hidden" value="{$description}" /> 
                                <input name="Order_Id" type="hidden" value="{$reference_no}" /> 
                               ...
                               <!-- <table width="70%" border="0" cellspacing="0" cellpadding="0">-->
            					...
            					<option value="{$cntry->countryid}" {if $cntry->countryid eq 113} selected="selected" {/if}>{$cntry->country}</option>
            					{/foreach}
            					</select>
                                </div>
				...
				<li class="blueBtnLi">
                                <input type="button" class="blueBtn"value="Pay Now"
                                 ...
                                 <li class="blueBtnLi"><input type="button" class="blueBtn" value="Cancel" onclick="javascript:window.location.href='{$baseurl}archive_projects/cancel_order/{$proj_id}';"/></li>
	</ul></div></td>
                               <td>&nbsp;</td>
                                </tr>
