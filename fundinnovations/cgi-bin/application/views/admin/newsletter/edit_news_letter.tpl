...
{/literal}
            <form name="frmNews" id="frmNews" method="post" action="" >
                <table width="100%" cellspacing="0" cellpadding="0" border="0" >
                    ...
                    <input type="text" name="news_title" id="news_title" class="styletxt40perc " tabindex="1" value="{$newsdt[0]->news_title}" />
                    </div>
                    </td>
                    </tr>
                    ...
                    <td  align="left" valign="top">
                    <div class="formValidation">
                    <input type="text" name="news_subject" id="news_subject" class="styletxt40perc "  tabindex="1" value="{$newsdt[0]->subject}" />
                    </div>
                    </td>
                    </tr> 
                    ...
                    <div align="left">
                   <textarea id="news_content" name="news_content" >{$newsdt[0]->news_content|stripslashes}</textarea>
                   <div class="error " id="proDescError"></div>  </div>
                    ...
                    <input type="button" value="Update" id="newsAddbtn" class="button" name="newsAddbtn" onClick="return validate_newsForm('{$baseurl}');" />
                    </span>
                    <span class="btnlayout ">
                       <input type="button" class="cancel" value="Cancel" name="text3" onclick="back_to_newsletter('{$baseurl}','{$currP}','{$order_by}')"/>
                    </span>
                    </td>
                    </tr>
                ...
                <input type="hidden" name="hid_newsid" id="hid_newsid" value="{$newsdt[0]->news_id}">
