<?php /* Smarty version Smarty-3.1.8, created on 2013-06-18 14:38:14
         compiled from "/home/fundinno/public_html/application/views/projects/payment_form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:669902510515bb788a54d70-73468898%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd6bc233aebb266fa113985d53390980df59d12ca' => 
    array (
      0 => '/home/fundinno/public_html/application/views/projects/payment_form.tpl',
      1 => 1371397029,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '669902510515bb788a54d70-73468898',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_515bb788bd7240_47104515',
  'variables' => 
  array (
    'proj_id' => 0,
...
<?php if ($_valid && !is_callable('content_515bb788bd7240_47104515')) {function content_515bb788bd7240_47104515($_smarty_tpl) {?><section class="innerMidWrap">
<div class="">
  <div class="contentBlock"> 

 
    <form  method="post" action="https://www.ccavenue.com/shopzone/cc_details.jsp" name="frmTransaction" id="frmTransaction" onSubmit="return validate()">
...
" />
  ...
  <tr><td colspan="2">&nbsp;<h3>Note:<span> Amount payable = Pre-Order Amount – FundInnovations Cash.</span> </h3></td></tr>
                                ...
                                <input name="Merchant_Id" id="Merchant_Id" type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['account_id']->value;?>
">     
                                <input name="Redirect_Url" type="hidden" size="60" value="<?php echo $_smarty_tpl->tpl_vars['return_url']->value;?>
" />
...
" size="60" name="secure_hash">
                                <input name="reference_no" type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['WorkingKey']->value;?>
" />
...
" /> 
                                <input name="Order_Id" type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['reference_no']->value;?>
" /> 
                                <input name="Checksum" type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['Checksum']->value;?>
" /> 
                               ...
                               <!-- <table width="70%" border="0" cellspacing="0" cellpadding="0">-->
                                ...
                                <div class="fieldTxP ">
                                <input name="billing_cust_name" type="text" value="" class="textBoxStyle" id="name"/>
                                </div>
                                </td>
                                </tr>
                                <tr>
                                ...
                                <td colspan="2">
                                <div class="fieldTxP ">
                                <textarea name="billing_cust_address" class="textBoxStyle height120"  id="address"></textarea>
                                </div>
                                </td>
                                </tr>
                                <tr>
                                ...
                                <td colspan="2">
                                 <div class="fieldTxP ">
                                 <select name="billing_cust_country" id="country" class="selectBx" onchange="getCountry(this.value)" />
...
" <?php if ($_smarty_tpl->tpl_vars['cntry']->value->countryid==113){?> selected="selected" <?php }?>><?php echo $_smarty_tpl->tpl_vars['cntry']->value->country;?>
                                ...
                                <div class="fieldTxP ">
                                <div id="state_load">
             					 <select name="billing_cust_state" id="state" class="selectBx" />
...
"  ><?php echo $_smarty_tpl->tpl_vars['c']->value['city_name'];?>
                                ...
                                <td colspan="2">
                                <div class="fieldTxP ">
                                <input name="billing_zip" class="textBoxStyle" type="text" id="postal_code" />
                                </div>
                                </td>
                                </tr>
                                ...
                                <td colspan="2">
                                <div class="fieldTxP ">
                                <input name="billing_cust_email" type="text" class="textBoxStyle" id="email"/>
                                </div>
                                </td>
                                </tr>
                                ...
                                <td colspan="2">
                                <div class="fieldTxP ">
                                <input name="billing_cust_tel" type="text" class="textBoxStyle" maxlength="20" id="phone"/>
                                </div>
                                </td>
                                </tr>
