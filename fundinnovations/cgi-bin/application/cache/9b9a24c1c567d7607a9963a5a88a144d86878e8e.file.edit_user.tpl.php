<?php /* Smarty version Smarty-3.1.8, created on 2013-02-14 18:39:41
         compiled from "/var/www/fundinnovations/application/views/admin/edit_user.tpl" */ ?>
<?php /*%%SmartyHeaderCode:359758699508a89ab719861-64784908%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9b9a24c1c567d7607a9963a5a88a144d86878e8e' => 
    array (
      0 => '/var/www/fundinnovations/application/views/admin/edit_user.tpl',
      1 => 1360847314,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '359758699508a89ab719861-64784908',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_508a89ab7f32f9_25928223',
  'variables' => 
  array (
    'baseurl' => 0,
    'users' => 0,
...
<?php if ($_valid && !is_callable('content_508a89ab7f32f9_25928223')) {function content_508a89ab7f32f9_25928223($_smarty_tpl) {?><!--<script type="text/javascript" src="<?php echo $_smarty_tpl->tpl_vars['baseurl']->value;?>
...
';
 ...
 $(document).ready(function(){
	 var cntry_id='<?php echo $_smarty_tpl->tpl_vars['users']->value[0]->country_id;?>
';
	 var state_id= '<?php echo $_smarty_tpl->tpl_vars['users']->value[0]->state_id;?>
';
	  var city_id= '<?php echo $_smarty_tpl->tpl_vars['users']->value[0]->city_id;?>
';
...
';
	...
	$('#updatebtn').click(function(){
		...
		if(validateprofileName() & validateEmail() & validateUserName() & validateFb_lnk() & confirmPass() & confirmPass() & validateCountry() & validateState() & validateCity()  & validateMobNo() )
     {
    ...
    <div class="table_listing font_segoe ">
      <form  name="edituser" id="edituser" method="post" enctype="multipart/form-data" autocomplete="off" >
        <table width="100%" cellspacing="0" cellpadding="0" border="0">
          ...
          <?php $_smarty_tpl->tpl_vars["curr_user"] = new Smarty_variable("Site User", null, 0);?>
          
          <tbody>
            <tr>
              <th colspan="2" align="left"><h2 style="margin-left:5px;">Update<?php echo $_smarty_tpl->tpl_vars['curr_user']->value;?>
</h2></th>
            </tr>
            <tr id="field_header" >
...
<?php }?></div></td>
            ...
            <tr  class="shade01">
              ...
              <td  align="left" valign="top"><div class="formValidation">
                  <input type="text" name="profileName" id="profileName" class="styletxt40perc" value="<?php echo $_smarty_tpl->tpl_vars['users']->value[0]->profile_name;?>
"/>
                </div></td>
            </tr>
            ...
            <tr >
              ...
              <td  align="left" valign="top"><div class="formValidation">
                  <input type="text" name="email_id" id="email_id" class="styletxt40perc" value="<?php echo $_smarty_tpl->tpl_vars['users']->value[0]->email_id;?>
"/>
                </div></td>
            </tr>
            <tr  class="shade01">
            ...
            <tr class="shade01" style="height:100px">
              ...
              <td valign="top" align="left"><div class="formValidation">
                  <textarea id="address" name="address" style="width:355px; height: 70px;" ><?php echo $_smarty_tpl->tpl_vars['users']->value[0]->address;?>
</textarea>
                </div></td>
            </tr>
            ...
            <tr >
              ...
              <td  align="left" valign="top"><div class="formValidation">
                  <input type="text" name="fb_prof_link" id="fb_prof_link" class="styletxt40perc" value="<?php echo $_smarty_tpl->tpl_vars['users']->value[0]->fb_link;?>
"/>
                </div></td>
            </tr>
            <tr  class="shade01">
              ...
              <td  align="left" valign="top"><div class="formValidation">
                  <input type="text" name="tw_prof_link" id="tw_prof_link" class="styletxt40perc" value="<?php echo $_smarty_tpl->tpl_vars['users']->value[0]->twitter_link;?>
"/>
                </div></td>
            </tr>
            <tr  >
...
" <?php if ($_smarty_tpl->tpl_vars['users']->value[0]->country_id==$_smarty_tpl->tpl_vars['cntry']->value->countryid){?> selected="selected" <?php }?> ><?php echo $_smarty_tpl->tpl_vars['cntry']->value->country;?>
</option>
                  <?php } ?>
                  </select>
                </div></td>
...
" ><?php echo $_smarty_tpl->tpl_vars['st']->value->state;?>
            ...
            <tr  class="shade01">
              ...
              <td  align="left" valign="top"><div class="formValidation">
                  <input type="text" name="mob_no" class="styletxt40perc" value="<?php echo $_smarty_tpl->tpl_vars['users']->value[0]->contact_no;?>
" id="mob_no" maxlength="16"/>
                </div></td>
            </tr>
            <tr >
              <td  align="left" valign="top">Web site </td>
              <td  align="left" valign="top"><div class="formValidation">
                  <input type="text" class="styletxt40perc" name="web_site" id="web_site" value="<?php echo $_smarty_tpl->tpl_vars['users']->value[0]->websites;?>
"/>
                </div></td>
            </tr>
            <tr class="shade01">
            <td  align="left" valign="top">Profile Image </td>
              <td  align="left" valign="top"><div class="selectImg">
                  <div id="prof_img_div"><img src="<?php echo $_smarty_tpl->tpl_vars['users']->value[0]->user_image;?>
" /></div>
                  
                  <a id="removeImg" class="uploadClose" <?php if ($_smarty_tpl->tpl_vars['users']->value[0]->profile_image==''){?> style="display:none;" <?php }?> >Remove image</a>
                ...
                <input type="hidden" name="profile_timg" id="profile_timg" value="<?php echo $_smarty_tpl->tpl_vars['users']->value[0]->profile_image;?>
" /></td>
            ...
            <tr >
              ...
              <td  align="left" valign="top"><div class="selectImg">
                <div class="commonUploadImg">
                  <div id="id_proof_div">
                  <?php if ($_smarty_tpl->tpl_vars['users']->value[0]->address_proof_image!=''){?>
                  <?php $_smarty_tpl->tpl_vars["ext"] = new Smarty_variable(pathinfo($_smarty_tpl->tpl_vars['users']->value[0]->address_proof_image,@PATHINFO_EXTENSION), null, 0);?>
...
uploads/user_id_proof/thumb/<?php echo $_smarty_tpl->tpl_vars['users']->value[0]->address_proof_image;?>
" ><img src="<?php echo $_smarty_tpl->tpl_vars['users']->value[0]->idProof;?>
...
" />-->
                  ...
                  <!--<a id="removeIdProof" class="uploadClose" <?php if ($_smarty_tpl->tpl_vars['users']->value[0]->address_proof_image==''){?> style="display:none;" <?php }?>>Remove id proof</a>-->
                 </div> 
                  <div class="chooseBtnPane">
                  ...
                  <input type="hidden" name="hid_id_proof" id="hid_id_proof" value="<?php echo $_smarty_tpl->tpl_vars['users']->value[0]->address_proof_image;?>
" /></td>
            </tr>
              <tr class="shade01">
              ...
              <div class="selectImg">
               ...
               <?php if ($_smarty_tpl->tpl_vars['users']->value[0]->address_id_proof==''){?>
               		 <!--<img src="<?php echo $_smarty_tpl->tpl_vars['baseurl']->value;?>
images/no_image.png" />-->
              		 <?php }else{ ?>
               <?php $_smarty_tpl->tpl_vars["ext"] = new Smarty_variable(pathinfo($_smarty_tpl->tpl_vars['users']->value[0]->address_id_proof,@PATHINFO_EXTENSION), null, 0);?>
                    <?php if ($_smarty_tpl->tpl_vars['ext']->value=='jpg'||$_smarty_tpl->tpl_vars['ext']->value=='png'||$_smarty_tpl->tpl_vars['ext']->value=='gif'){?>
...
images/no_image.png" />
              		 <?php }else{ ?>
               		<a class='aproof1' href="<?php echo $_smarty_tpl->tpl_vars['baseurl']->value;?>
uploads/user_address_proof/thumb/<?php echo $_smarty_tpl->tpl_vars['users']->value[0]->address_id_proof;?>
" ><img src="<?php echo $_smarty_tpl->tpl_vars['baseurl']->value;?>
uploads/user_address_proof/thumb/<?php echo $_smarty_tpl->tpl_vars['users']->value[0]->address_id_proof;?>
" width="97" height="95" /></a>
                	<!--	<img src="<?php echo $_smarty_tpl->tpl_vars['baseurl']->value;?>
...
" />
               ...
               <!--<a id="removeAddProof" class="uploadClose" <?php if ($_smarty_tpl->tpl_vars['users']->value[0]->address_id_proof==''){?> style="display:none;" <?php }?>>Remove address proof</a>-->
               </div> 
          <input type="file" id="addr_proof" name="addr_proof" />
          <input type="hidden" name="hid_addr_proof" id="hid_addr_proof" value="<?php echo $_smarty_tpl->tpl_vars['users']->value[0]->address_id_proof;?>
" />
        </div>
        </td></tr>
...
admin/users/manage_siteusers'"/>
        ...
        <input type="hidden" id="hid_uid" name="hid_uid" value="<?php echo $_smarty_tpl->tpl_vars['uid']->value;?>
" />
      </form>
    </div>
  </div>
