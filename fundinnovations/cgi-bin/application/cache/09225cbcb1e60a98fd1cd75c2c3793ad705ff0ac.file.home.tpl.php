<?php /* Smarty version Smarty-3.1.8, created on 2013-02-22 16:40:02
         compiled from "/var/www/fundinnovations/application/views/home.tpl" */ ?>
<?php /*%%SmartyHeaderCode:141106606050caf00ec162d0-23428706%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '09225cbcb1e60a98fd1cd75c2c3793ad705ff0ac' => 
    array (
      0 => '/var/www/fundinnovations/application/views/home.tpl',
      1 => 1361530824,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '141106606050caf00ec162d0-23428706',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_50caf00ed1ac29_74170539',
  'variables' => 
  array (
    'baseurl' => 0,
    'website_intro' => 0,
...
<?php if ($_valid && !is_callable('content_50caf00ed1ac29_74170539')) {function content_50caf00ed1ac29_74170539($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/var/www/fundinnovations/application/libraries/Smarty/libs/plugins/modifier.truncate.php';
...
video/main_video.flv" style="display:block;width:509px;height:281px"  id="player"> 
		</a>
 <![endif]-->
 <![if gte IE 9]>
...
video/main_video.flv" type='video/flv' />
    ...
    <div class="clear"></div>
    <h2 class="gapL273" style="position:relative; padding-right:147px; width:650px; margin:0 auto"><?php echo smarty_modifier_truncate($_smarty_tpl->tpl_vars['website_intro']->value['page_content'],100);?>
 <!--Do you think India will be the next global power? Then start the innovation revolution today...--><span style="display:inline-block; position:absolute;right:0"><a href="javascript:void(0);" onclick="$('#lern_more_popup').show();openpPopup();" class="lrnMrBtn gapM4">Learn more</a></span></h2>
  </div>
 </div> 
...
<div class="popabs">
<div id="inlineContent2" class="white_content" style="top:209px">
  <div class="white_contentInner" ><a style=" top: 0;right:0; position:absolute;margin:0 !important" class="closeBtn" href = "javascript:void(0)" onclick ="close_pop('lern_more_popup');">Close</a>
    <div id="learnMOrepopFix"><h4></h4>
      <div id="lern_more_pop_cntnt" class="prodeForm">
      </div>
