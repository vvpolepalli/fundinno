<?php /* Smarty version Smarty-3.1.8, created on 2013-04-03 05:13:34
         compiled from "/home/fundinno/public_html/application/views/projects/innovate_projects_images.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1105180909515acde6994368-00361199%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'eae8578073c7f23e964577dfcd45b2122ff83f87' => 
    array (
      0 => '/home/fundinno/public_html/application/views/projects/innovate_projects_images.tpl',
      1 => 1364987503,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1105180909515acde6994368-00361199',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_515acde6c20067_75317862',
  'variables' => 
  array (
    'baseurl' => 0,
    'proj_id' => 0,
...
<?php if ($_valid && !is_callable('content_515acde6c20067_75317862')) {function content_515acde6c20067_75317862($_smarty_tpl) {?><link rel="stylesheet" type="text/css" href="<?php echo $_smarty_tpl->tpl_vars['baseurl']->value;?>
...
">Images<span class="arrowtabs"></span></a></li>
		<li><a href="<?php echo $_smarty_tpl->tpl_vars['baseurl']->value;?>
...
<div class="innerMidContent">
	...
	<div class="imgUpload">
			...
			<li <?php if ($_smarty_tpl->tpl_vars['cnt']->value%3==0){?> class="last" <?php }?> ><!--<span class="delBtn" style="cursor:pointer" onclick="confirm_pop(<?php echo $_smarty_tpl->tpl_vars['photo']->value['id'];?>
...
?>
			<li <?php if ($_smarty_tpl->tpl_vars['cnt']->value%3==0){?> class="last" <?php }?> ><span class="delBtn" style="cursor:pointer" onclick="confirm_pop(<?php echo $_smarty_tpl->tpl_vars['photo']->value['id'];?>
)" >Remove this image</span> <a class="fancybox" href="<?php echo $_smarty_tpl->tpl_vars['baseurl']->value;?>
...
</span> <a  onclick="toggle_visibility(<?php echo $_smarty_tpl->tpl_vars['photo']->value['id'];?>
);" class="editLinkNew" href="javascript:void(0)">Edit</a></div>
		   <div class="clear"></div>
		   <div class="txtBoxPane" id="txtBoxPane_<?php echo $_smarty_tpl->tpl_vars['photo']->value['id'];?>
" style="display:none"><input class="textBoxStyle" type="text" id="img_caption_<?php echo $_smarty_tpl->tpl_vars['photo']->value['id'];?>
" name="img_caption_<?php echo $_smarty_tpl->tpl_vars['photo']->value['id'];?>
" maxlength="38"><input type="button" class="blueBtn" id="update<?php echo $_smarty_tpl->tpl_vars['photo']->value['id'];?>
" onclick="update_caption(<?php echo $_smarty_tpl->tpl_vars['photo']->value['id'];?>
)" value="Update"></div>
		   </div>
            </li>
