<?php /* Smarty version Smarty-3.1.8, created on 2013-02-22 09:49:16
         compiled from "/var/www/fundinnovations/application/views/projects/pro_det_test.tpl" */ ?>
<?php /*%%SmartyHeaderCode:16832074425123593b2d5a51-47782227%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '124f4693b33f3918cd077ce7ebc13b7b7acbf1ff' => 
    array (
      0 => '/var/www/fundinnovations/application/views/projects/pro_det_test.tpl',
      1 => 1361460291,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16832074425123593b2d5a51-47782227',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_5123593b68bba3_80269826',
  'variables' => 
  array (
    'baseurl' => 0,
    'user_id' => 0,
...
<?php if ($_valid && !is_callable('content_5123593b68bba3_80269826')) {function content_5123593b68bba3_80269826($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/fundinnovations/application/libraries/Smarty/libs/plugins/modifier.date_format.php';
...
';
		...
		//var descpn ='<?php echo stripslashes($_smarty_tpl->tpl_vars['project_det']->value['short_description']);?>
';
...
</span> <span class="creterfield"><?php echo $_smarty_tpl->tpl_vars['project_det']->value['category_name'];?>
</span>
      <div class="clear"></div>
...
">
          <div class="custom_images">
            <ul class="socialShare">
              <li>Share With :</li>
              <li><a class=" fb" target="_blank" href="https://www.facebook.com/dialog/feed?app_id=461303437265872&link=<?php echo $_smarty_tpl->tpl_vars['baseurl']->value;?>
archive_projects/project_details_test/<?php echo $_smarty_tpl->tpl_vars['proj_id']->value;?>
...
&description=<?php echo stripslashes($_smarty_tpl->tpl_vars['project_det']->value['short_description']);?>
" style="cursor:pointer"><img src="" alt="fb" /></a></li>
...
" data-count="none" ><img src="" alt="twit" /></a></li>
              <li><!--http://api.addthis.com/oexchange/0.8/forward/linkedin/offer?url=<?php echo $_smarty_tpl->tpl_vars['baseurl']->value;?>
archive_projects/project_details/<?php echo $_smarty_tpl->tpl_vars['proj_id']->value;?>
-->
...
profile/index/<?php echo $_smarty_tpl->tpl_vars['project_det']->value['user_id'];?>
"><?php echo $_smarty_tpl->tpl_vars['project_det']->value['profile_name'];?>
</a></li>
          <li>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <th width="50%" scope="col"><span class="label1">Days to go</span> <br>
              <span class="derails1"><?php if ($_smarty_tpl->tpl_vars['project_det']->value['remaining_days']<0){?>0<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['project_det']->value['remaining_days'];?>
<?php }?></span></th>
          </tr>
          <tr>
        ...
        <ul class="details2">
          ...
          <div class="label"><span class="left">Project start date</span><span class="right">:</span></div>
            <div class="details"><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['project_det']->value['created_date']);?>
</div>
            <div class="clear"></div>
        ...
        <div class="blueBtnLi left">
          <input type="button" class="blueBtn" id="btn_fund_project" name="btn_fund_project" onclick="fund_project_pop(<?php echo $_smarty_tpl->tpl_vars['proj_id']->value;?>
)" value="Pre-Order Items">
        </div>
        <?php }?><?php }?><?php }?><?php }?>
...
">
            <div class="custom_images">
              <ul class="socialShare socialShareblck" <?php if ($_smarty_tpl->tpl_vars['project_det']->value['promote_link']==''){?>  style="display:none;" <?php }?>>
                <li>
                <a target="_blank" class="fb show_soc" href="https://www.facebook.com/dialog/feed?app_id=461303437265872&link=<?php echo $_smarty_tpl->tpl_vars['project_det']->value['promote_link'];?>
&picture=<?php echo $_smarty_tpl->tpl_vars['baseurl']->value;?>
uploads/projects/images/medium/<?php echo $_smarty_tpl->tpl_vars['project_det']->value['project_image'];?>
&name=<?php echo $_smarty_tpl->tpl_vars['project_det']->value['project_title'];?>
&caption=<?php echo $_smarty_tpl->tpl_vars['project_det']->value['project_title'];?>
...
%</li>
     ...
     <?php if ($_smarty_tpl->tpl_vars['project_det']->value['remaining_days']>=0&&$_smarty_tpl->tpl_vars['project_det']->value['remaining_days']<=$_smarty_tpl->tpl_vars['project_det']->value['fund_duration']){?>
       <?php if ($_smarty_tpl->tpl_vars['project_det']->value['backers_cnt']<$_smarty_tpl->tpl_vars['project_det']->value['max_sponsors']||$_smarty_tpl->tpl_vars['project_det']->value['max_sponsors']==0){?>
       <?php if ($_smarty_tpl->tpl_vars['project_det']->value['user_id']!=$_smarty_tpl->tpl_vars['user_id']->value){?>
      <?php if ($_smarty_tpl->tpl_vars['project_det']->value['rewards']!=0){?><!--<pre><?php echo print_r($_smarty_tpl->tpl_vars['project_det']->value['rewards']);?>
</pre>-->
...
?>
     <?php if ($_smarty_tpl->tpl_vars['reward']->value['taken_cnt']<$_smarty_tpl->tpl_vars['reward']->value['users_limit']||$_smarty_tpl->tpl_vars['reward']->value['users_limit']==0){?>
      <div class="pledgeMorePane">
        <h4 onclick="fund_reward_pop(<?php echo $_smarty_tpl->tpl_vars['proj_id']->value;?>
,<?php echo $_smarty_tpl->tpl_vars['reward']->value['id'];?>
)" style="cursor:pointer;padding-bottom:5px;">Pre-Order <span class="WebRupee">Rs. </span><?php echo $_smarty_tpl->tpl_vars['reward']->value['pledge_amount'];?>
<!-- or more--></h4>
