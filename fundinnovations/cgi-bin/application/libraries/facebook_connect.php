 ...
 **/
	...
	include('application/libraries/facebook-client/facebook.php');
	...
	class Facebook_connect {
...

		{
...

			{
				...
				try {
					...
					$this->user = $this->client->fql_query('SELECT uid, first_name,
				...
				interests,website,locale,

				status FROM user WHERE uid = ' . $this->fb->get_loggedin_user());
...

		{
...

			{
				...
				$info = $this->client->fql_query('SELECT uid, first_name,
