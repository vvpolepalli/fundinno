...
/*$burl = $_GET['burl'];
 ...
 include($_SERVER['DOCUMENT_ROOT']."/application/libraries/connect.php"); 
...
if (!isset($_FILES["Filedata"]) || !is_uploaded_file($_FILES["Filedata"]["tmp_name"]) || $_FILES["Filedata"]["error"] != 0)

 {
	...
	if (!$width || !$height || $width <$target_width1 || $height<$target_height1) {

		echo "Please upload images of size, Minimum 850 X 281";
	...
	$uplaod_path=$_SERVER['DOCUMENT_ROOT'].'/uploads/image_banner/original/';

	$thumb_img_path=$_SERVER['DOCUMENT_ROOT'].'/uploads/image_banner/thumb/';

	$medium_img_path=$_SERVER['DOCUMENT_ROOT'].'/uploads/image_banner/medium/';
	...
	//sumesh
...

	 {
		  ...
		  imagejpeg($new_img1,$medium_img_path.$thumb_img_name);
...

	 {
		 ...
		 imagepng($new_img1,$medium_img_path.$thumb_img_name);
