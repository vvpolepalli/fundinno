...
$targetFolder = '/uploads/projects'; // Relative to the root
...
if (!empty($_FILES)) {
	...
	if (in_array($fileParts['extension'],$fileTypes)) {
		...
		$targetFile = rtrim($targetPath,'/').'/images/original/'.$filename;
		...
		//	if($h >=150 && $w>=200){
			...
			resizeImageWdthHegt($targetFile,233,140,$thumb_path);

			resizeImageWdthHegt($targetFile,330,190,$medium_path);
